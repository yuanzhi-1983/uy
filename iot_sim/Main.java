...
public class Main implements AutoCloseable {
	...
	public Main(SimConfig config) throws Exception {
		...
		// start MQTT server
		this.mqtt= new MqttCommands(plugs,config.getMqttBroker(),config.getMqttClientId(),config.getMqttTopicPrefix());
		this.mqtt.start();
	}
	...
	private final MqttCommands mqtt;
	/////
	// private static List<MqttCommands> subscribers_c=new ArrayList<>();
	//////
